    ...
    for (const s of sessions) {
      ...
      if (sheet) {
        ...
        for (const row of rows) {
          ...
          // 💡【核心修復】：若 Email 和 姓名 通通為空，說明此列無效，跳過不讀取！
          if (!email && !name) {
            continue;
          }
